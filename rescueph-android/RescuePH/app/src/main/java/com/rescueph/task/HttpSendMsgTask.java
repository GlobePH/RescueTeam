 ...
 */
public class HttpSendMsgTask extends AsyncTask<Void,Void,Messages> {

    private static Messages messages;
    private OnTaskCompleted listener;
    private String url = "http://"+ MainActivity.IP+":8080/rescueph/rest/messages/add";
    private static final String TAG = "HttpSendingMsgTask";

    public HttpSendMsgTask(Messages messages, OnTaskCompleted listener) {
        super();
    ...
    protected Messages doInBackground(Void... params) {
        ...
        try {
            ...
            messages = restTemplate.postForObject(url,messages,Messages.class);
        }catch (Exception e){
            messages = null;
